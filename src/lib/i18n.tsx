...
const dict = {
  fr: {
    ...
    admin_markupHint: "Mise en forme : ## Titre · - liste · **gras** · *italique* · [[IMG: description]] · [!PIEGE] · [!INFO] · [!APP] consigne ||| correction",
  ...
  en: {
    ...
    admin_markupHint: "Formatting: ## Heading · - list · **bold** · *italic* · [[IMG: description]] · [!PIEGE] · [!INFO] · [!APP] prompt ||| answer",
