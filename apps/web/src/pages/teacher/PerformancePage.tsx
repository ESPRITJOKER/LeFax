...
export function PerformancePage() {
  ...
  return (
    <div>
      <h1 className="font-headline-lg text-headline-lg text-excellence-blue mb-lg">Performance du contenu</h1>
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-gutter mb-lg">
        <div className="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant flex flex-col gap-sm">
          ...
          <span className="font-label-lg text-label-lg text-text-secondary">Publiés</span>
        ...
        <div className="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant flex flex-col gap-sm">
          ...
          <span className="font-label-lg text-label-lg text-text-secondary">En révision</span>
        ...
        <div className="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant flex flex-col gap-sm">
          ...
          <span className="font-label-lg text-label-lg text-text-secondary">Brouillons</span>
        ...
        <div className="bg-surface-container-lowest p-lg rounded-xl border border-outline-variant flex flex-col gap-sm">
          ...
          <span className="font-label-lg text-label-lg text-text-secondary">Rejetés</span>
          <span className="font-display-lg text-display-lg text-excellence-blue">{counts.rejected}</span>
        </div>
      </section>
      <p className="font-body-sm text-body-sm text-text-secondary">
        Les taux de complétion étudiants et la rémunération estimée nécessitent des données d'engagement réelles
        (leçons vues, QCMs tentés) qui n'existent pas encore pour ce contenu.
      </p>
    </div>
  );
}
